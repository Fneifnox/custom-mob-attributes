...
public class RibbitsCompat {
    ...
    public static void initRibbitsAttributeHandlers() {
        ...
        AttributeUpdater.ATTRIBUTE_HANDLERS.put(ribbit, entity -> {
            AttributeUpdater.configureEntityAttributes(entity.getEntityWorld(), entity, CONFIG.ribbits::healthMultiplierForRibbit, CONFIG.ribbits::damageMultiplierForRibbit, CONFIG.ribbits::speedMultiplierForRibbit, CONFIG.ribbits::scaleMultiplierForRibbit
            );
        });
    }
}
