    ...
    public static <T extends LivingEntity> void configureEntityAttributes(
        ...
        if (CONFIG.adultsAlsoAffectBabies() && entity.isBaby()) {
            ...
            if (scaleMultiplier != null && extraMultiplier.length >= 4) {
                updateModifier(entity, CustomMobAttributes.SCALE, SCALE_MODIFIER_UUID, scaleMultiplier.get() * extraMultiplier[3].get() * CONFIG.scaleMultiplierForBabyAll() * CONFIG.scaleMultiplierForAll());
            }
        }
            ...
            if (scaleMultiplier != null) {
                updateModifier(entity, CustomMobAttributes.SCALE, SCALE_MODIFIER_UUID, scaleMultiplier.get() * (entity.isBaby() ? CONFIG.scaleMultiplierForBabyAll() : CONFIG.scaleMultiplierForAll()));
            }
        }
    }
